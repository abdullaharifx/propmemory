...
const DEMO_EMAIL = 'demo@propmemory.com'
...
export default function Login() {
  ...
  useEffect(() => { document.title = 'PropMemory — Sign in' }, [])
  ...
  async function handleDemo() {
    ...
    try {
      ...
      if (error) throw new Error('Demo account not set up yet. See DEMO_SETUP.md for instructions.')
      navigate('/dashboard')
    } catch (err) {
      setError(err.message)
    } finally {
    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '400px' }}>
        ...
        <div style={{
          ...
          <span style={{ fontSize: '22px', fontWeight: '600', color: 'var(--color-text-primary)', letterSpacing: '-0.3px' }}>
            PropMemory
          </span>
        </div>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            <button
              ...
              onMouseLeave={e => { if (!loading) e.currentTarget.style.backgroundColor = 'var(--color-accent)' }}
            >
              {loading
          ...
          <div style={{ marginTop: '18px', textAlign: 'center', fontSize: '13px', color: 'var(--color-text-secondary)' }}>
            ...
            <button onClick={toggleMode} style={{ background: 'none', border: 'none', padding: 0, fontSize: '13px', fontFamily: 'var(--font-sans)', color: 'var(--color-accent)', cursor: 'pointer', fontWeight: '500' }}>
